<?php get_header();?>
    <section style="background-image: url(<?php echo get_theme_file_uri('/images/library-hero.jpg'); ?>);">
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="container white-text" >
                    ...
                    <p class="center"><a href="<?php echo get_post_type_archive_link('recipe');?>" class="btn center">View All Recipes</a></p>
                </div>
            </div>
        </div>
    </section>
    <section>
        <div class="row">
            ...
            <div class="col s12 m6 l6">
                <h4 class="center">Upcoming Events</h2>
                <?php 
                $today = date('Ymd');
            ...
            <!--Blog Area-->
            <div class="col s12 m6 l6">
             <h4 class="center">From Our Blogs</h2>
             <?php 
